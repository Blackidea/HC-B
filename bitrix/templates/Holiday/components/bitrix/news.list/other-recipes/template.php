...
<?
    ...
    <? $counter++; ?>
        <? if (counter <= $arParams['NEWS_COUNT']) { ?>
                                <div class="item">
									<div class="item_image"><a href="<?= $arItem["DETAIL_PAGE_URL"]?>"><img src="<?= $arItem["PREVIEW_PICTURE"]["SRC"] ?>" alt="<? echo $arItem["NAME"] ?>"></a></div>
									<div class="item_text">
										...
										<div class="item_bar">
											...
											<div class="item_clock">
													...
													<span><?=$arItem["DISPLAY_PROPERTIES"]["duration"]["VALUE"]?> мин.</span>
											</div>
										</div>
									</div>
								</div>
